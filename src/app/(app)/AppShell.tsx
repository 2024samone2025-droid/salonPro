...
// Client shell for the authenticated app. Tenant existence is already guaranteed
// by the server layout (it notFound()s unknown subdomains before we get here);
// this layer handles the client-side auth gate via useAuth().
